	...
	int &x, int &y)
{
	...
	if (findShip)
	{
		if (findDirection)
		{
			...
			///////////////////////////////////////////
			// Меняем направление обстрела
			if (directionNotRedefine)
			{
				...
				directionNotRedefine = !directionNotRedefine;
			}
			///////////////////////////////////////////
			else
			{
		...
		else
		{
			...
			do
			{
				...
				&& (x < sizeRectangleWeb - 1) && (x > 1) && (y < sizeRectangleWeb - 1) && (y > 1));// Проверка на выход за границы 
			/////////////////////////////////////////////
